...
files=(
#/scratch/data/testbeam201905/Data_runs/Run_20190504_225322.dat
...
#/scratch/data/testbeam201905/Data_runs/Run_20190505_111442.dat_Run_20190505_111442.cluster.root
...
do
	...
	#python2.7 python/plot_producer.py $i"_"$substring$extension -n noise_distribution _b0  -k 6 7 8 9 10 11 -b 0 -d 'hist e same' -o noise_distribution_upstream --refuse 16 13 12 _c --legend S34-1 S34-2 S53-1 S53-2 S55-1 S55-2
...
#for i in ${kpix[*]}
#do
	#python2.7 python/plot_producer.py /scratch/data/testbeam201905/Data_runs/Run_20190505_094624.dat_Run_20190505_094624.cluster.root /scratch/data/testbeam201905/Data_runs/Run_20190505_100835.dat_Run_20190505_100835.cluster.root -n "noise_distribution_"$i"_b0" -d 'hist e same' -o "noise_distribution_new_gain_comparison_"$i --legend NormalGain HighGain
#done
#python2.7 python/plot_producer.py /scratch/data/testbeam201905/Data_runs/Run_20190505_094624.dat_Run_20190505_094624.cluster.root /scratch/data/testbeam201905/Data_runs/Run_20190505_100835.dat_Run_20190505_100835.cluster.root -n cluster-correlation sens0 sens2 -d 'colz'
